...
function insertNewTwit(twitText, twitAuthor) {
  ...
  var templateInfo = { Text: twitText, Author: twitAuthor};
  console.log("works?", Text);

  var templateInfoHTML = Handlebars.templates.template(templateInfo);
  var twitContainer = document.getElementsByClassName('twit');
  twitContainer.insertAdjacentHTML('beforeend', templateInfoHTML);
}
